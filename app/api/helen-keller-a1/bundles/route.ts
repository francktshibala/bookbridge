...
export async function GET(request: NextRequest) {
  try {
    ...
    // This API supports "Helen Keller - The Story of My Life" for A1 level
    if (bookId !== 'helen-keller' && bookId !== 'helen-keller-a1') {
      return NextResponse.json({
        success: false,
        error: 'This API only supports Helen Keller - The Story of My Life A1'
      }, {
        status: 400,
        headers: {
    ...
    console.log(`🎤 Loading "Helen Keller - The Story of My Life" bundles for level: ${level}`);
    ...
    if (chunkCount === 0) {
      return NextResponse.json({
        success: false,
        error: 'No bundles found for Helen Keller - The Story of My Life A1'
      }, {
        status: 404,
    ...
    console.error('❌ Error loading Helen Keller bundles:', error);
    return NextResponse.json({
      success: false,
