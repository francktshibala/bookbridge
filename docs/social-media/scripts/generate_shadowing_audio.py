...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-shadowing-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/shadowing-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-shadowing.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for shadowing practice...")
