...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-intro-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/intro-section-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-intro.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for video introduction...")
...
print(f"\n✅ SUCCESS! Introduction audio saved to: {FINAL_OUTPUT}")
