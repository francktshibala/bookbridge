...
SCRIPT_FILE = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-vocabulary-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-vocabulary-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-vocabulary.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for Part 1 Vocabulary...")
...
print(f"\n✅ SUCCESS! Vocabulary audio saved to: {FINAL_OUTPUT}")
