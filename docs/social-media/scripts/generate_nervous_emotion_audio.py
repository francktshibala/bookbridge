...
SCRIPT_FILE = os.path.expanduser("~/Desktop/nervous-emotion-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/nervous-emotion-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/nervous-emotion.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for 'Nervous' emotion video...")
