...
SCRIPT_FILE = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-hook-script-NEW.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-hook-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-hook.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for Part 1 Hook...")
