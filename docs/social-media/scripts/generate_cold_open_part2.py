...
SCRIPT_FILE = os.path.expanduser("~/Desktop/cold-open-part2-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/part2-audio-temp/cold-open")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/cold-open-part2.mp3")

Path(OUTPUT_DIR).mkdir(parents=True, exist_ok=True)

print("🎙️ Generating Cold Open Part 2...")
