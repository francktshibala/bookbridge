...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-cta-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/part2-audio-temp/cta")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-cta.mp3")

Path(OUTPUT_DIR).mkdir(parents=True, exist_ok=True)

print("🎙️ Generating cta...
