...
SCRIPT_FILE = os.path.expanduser("~/Desktop/slow-english-intro-REVISED.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/intro-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/slow-english-intro-final.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for intro video...")
...
# Stop parsing when we hit the duration marker
...
print("🎙️ Step 3: Generating audio via ElevenLabs...")
audio_files = []
text_index = 0
