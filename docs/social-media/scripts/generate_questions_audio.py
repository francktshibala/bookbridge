...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-questions-part1-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/questions-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-questions-part1.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for comprehension questions...")
...
print("🎙️ Step 3: Generating audio via ElevenLabs (Jane voice)...")
audio_files = []
text_index = 0
...
print(f"\n✅ SUCCESS! Questions audio saved to: {FINAL_OUTPUT}")
