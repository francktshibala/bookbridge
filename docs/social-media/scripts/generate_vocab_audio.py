...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-vocab-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/vocab-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-vocab.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for vocabulary section...")
