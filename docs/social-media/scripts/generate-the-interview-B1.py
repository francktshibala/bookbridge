...
SCRIPT_FILE = os.path.expanduser("~/Desktop/the-interview-B1-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/the-interview-B1-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/the-interview-B1.mp3")

Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for The Interview - B1 Level...")
...
if response.status_code == 200:
    temp_audio = f"{OUTPUT_DIR}/B1_original.mp3"
...
print(f"\n✅ SUCCESS! B1 audio saved to: {FINAL_OUTPUT}")
