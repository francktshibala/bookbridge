...
SCRIPT_FILE = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-cliffhanger-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-cliffhanger-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/he-arrived-20-dream-part1-cliffhanger.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for Part 1 Cliffhanger...")
...
print(f"\n✅ SUCCESS! Cliffhanger audio saved to: {FINAL_OUTPUT}")
