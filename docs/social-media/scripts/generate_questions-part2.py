...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-questions-part2-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/part2-audio-temp/questions-part2")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-questions-part2.mp3")

Path(OUTPUT_DIR).mkdir(parents=True, exist_ok=True)

print("🎙️ Generating questions-part2...
