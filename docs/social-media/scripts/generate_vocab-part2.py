...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-vocab-part2-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/part2-audio-temp/vocab-part2")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-vocab-part2.mp3")

Path(OUTPUT_DIR).mkdir(parents=True, exist_ok=True)

print("🎙️ Generating vocab-part2...
