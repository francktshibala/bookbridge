...
SCRIPT_FILE = os.path.expanduser("~/Desktop/romantic-love-hook-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/hook-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/romantic-love-hook.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for hook...")
...
print(f"\n✅ SUCCESS! Hook audio saved to: {FINAL_OUTPUT}")
