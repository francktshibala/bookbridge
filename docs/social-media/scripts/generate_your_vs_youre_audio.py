...
SCRIPT_FILE = os.path.expanduser("~/Desktop/your-vs-youre-script.txt")
OUTPUT_DIR = os.path.expanduser("~/Desktop/your-vs-youre-audio-temp")
FINAL_OUTPUT = os.path.expanduser("~/Desktop/your-vs-youre.mp3")

# Create temp directory
Path(OUTPUT_DIR).mkdir(exist_ok=True)

print("🎙️ Starting audio generation for 'Your vs You're' confusing words video...")
