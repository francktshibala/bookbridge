...
/**
 * Simplify "Teen Translating for Parents Through Hospital Chaos" to A1 level
...
- Keep proper nouns: Maria, Sofia, etc.
`;
...
6. Keep proper nouns unchanged (Maria, Sofia, etc.)
