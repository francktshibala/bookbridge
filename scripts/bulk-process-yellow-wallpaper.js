...
// Configuration for The Yellow Wallpaper
const BOOK_ID = 'gutenberg-1952' // The Yellow Wallpaper
...
async function detectChunkCount() {
  ...
  const maxChunks = 30 // Maximum to check (Yellow Wallpaper is very short)
  let detectedCount = 0
...
async function main() {
  ...
  console.log(`${colors.bright}📕 BULK PROCESSING THE YELLOW WALLPAPER${colors.reset}`)
  console.log('='.repeat(58))
  console.log(`  Book ID: ${BOOK_ID}`)
  console.log(`  Author: Charlotte Perkins Gilman`)
  ...
  try {
    ...
    if (remaining > 0) {
      ...
      console.log(`${colors.green}🎉 THE YELLOW WALLPAPER FULLY PROCESSED!${colors.reset}`)
    }
