...
console.log(`🎵 Generating audio bundles for "How Great Leaders Inspire Action"`);
console.log(`📚 Book ID: ${BOOK_ID}`);
console.log(`🎯 CEFR Level: ${CEFR_LEVEL}`);
console.log(`🗣️ Voice: Daniel (${DANIEL_VOICE_SETTINGS.voice_id}) - Natural, warm voice`);
console.log(`⚡ Speed: Generate at 0.90×, FFmpeg slow to 0.85×`);

if (isPilot) {
  console.log('🧪 PILOT MODE: Will generate only first 10 bundles (~$1.50 cost)');
}
