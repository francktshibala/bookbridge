...
- Add more detail to emotional moments (leaving abusive relationship, homelessness, hotel room, craft fair moment, "you are seen")
- Expand dialogue and interactions between Isabella and her children (Gabriel and Olivia)
- Add more scenes showing Isabella's struggles and transformation
- Keep natural A1 flow
- Add new sentences to expand, don't merge existing ones
- Keep proper nouns: Isabella, Gabriel, Olivia
  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are expanding A1 level text for ESL learners. Maintain A1 constraints (max 12 words/sentence, simple vocabulary) while adding detail and emotion. Keep proper nouns unchanged (Isabella, Gabriel, Olivia).',
        },
        {
          role: 'user',
          content: prompt,
