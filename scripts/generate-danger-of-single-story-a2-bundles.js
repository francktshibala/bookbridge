...
console.log(`🎵 Generating audio bundles for "The Danger of a Single Story"`);
...
const simplifiedTextPath = path.join(process.cwd(), 'cache/ted-talks/danger-of-single-story-a2-simplified.txt');
...
async function generateBundles() {
  ...
  for (let i = 0; i < bundlesToProcess.length; i++) {
    ...
    try {
      ...
      // Upload to Supabase
      const fileName = `danger-of-single-story/${CEFR_LEVEL}/bundle_${bundle.bundleIndex}.mp3`;
