...
/**
 * Simplify "Cultural Bridge #2" to A1 level
...
- Keep proper nouns: Jin, Greece, America, United States, etc.
`;
...
6. Keep proper nouns unchanged (Jin, Greece, America, United States, etc.)
...
async function simplifyToA1() {
  console.log('📝 Simplifying Cultural Bridge #2 to A1 level...');
