...
// PRODUCTION VOICE SETTINGS - Jane (Grief to Purpose narration)
...
async function main() {
  console.log('🎤 Generating combined preview audio for "Grief to Purpose #1"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-grief-to-purpose-1-preview-combined.js first.`);
  }
