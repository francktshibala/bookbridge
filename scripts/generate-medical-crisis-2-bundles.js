...
if (!VALID_LEVELS.includes(targetLevel)) {
  ...
  console.log('Usage: node scripts/generate-medical-crisis-2-bundles.js [A1|A2] [--pilot]');
  process.exit(1);
}
...
async function generateBundles() {
  try {
    ...
    const SENTENCES_PER_BUNDLE = 5; // ~5 sentences per bundle for 189 sentences = ~38 bundles
    const bundles = [];
