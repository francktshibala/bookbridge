...
// PRODUCTION VOICE SETTINGS - Jane (Biography narration)
...
// Preview text for the biography (A1 level - simple, short sentences)
const PREVIEW_TEXT = "In this inspiring story, José Hernández was a migrant farmworker. He did not speak English until he was 12. NASA turned him down eleven times. But he never gave up. Through hard work and education, he became an astronaut. He flew to space in 2009. A powerful message about dreams, perseverance, and never giving up.";
...
async function main() {
  console.log('🚀 Generating preview for "José Hernández: From Farmworker to Astronaut"');
  console.log(`📊 Level: ${CEFR_LEVEL}`);
  console.log(`📝 Preview text (${PREVIEW_TEXT.split(/\s+/).length} words):`);
  ...
  console.log(`✅ Saved preview text to cache`);
