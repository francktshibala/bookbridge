/**
 * Generate combined preview text (Preview + Background + Hook) for Cultural Bridge #1 story
...
const STORY_ID = 'cultural-bridge-2';
const CEFR_LEVEL = 'A1';
const CACHE_DIR = path.join(__dirname, '..', 'cache');

async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Cultural Bridge #1...');
...
- Describe Jin and her challenge (parents want safe careers like doctor/lawyer, but she wants creative/passion career, pressure to honor sacrifices)
- Mention main themes (traditional expectations vs personal dreams, choosing own path, bridging two worlds)
- Key insight: "Through choosing her own dreams, Jin learns that maybe choosing your own path is the ultimate expression of gratitude"
- Impact: "A powerful message about honoring parents' sacrifices while following your own heart, bridging traditions and modern life"
- Use character name "Jin" (composite story from 3 sources, NOT based on any single real person)
