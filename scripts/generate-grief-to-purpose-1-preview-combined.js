/**
 * Generate combined preview text (Preview + Background + Hook) for Grief to Purpose #1 story
...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Grief to Purpose #1...');
...
- Describe Anna and her loss (son Ethan dies in accident, devastating grief)
- Mention transformation (finding Ethan's list, deciding to help others, creating Ethan's Connection)
- Key themes: grief, loss, finding purpose, helping others, transforming pain into service
- Impact: "A moving story about finding meaning in tragedy and honoring loved ones through helping others"
- Use character name "Anna" (composite story from 4 sources, NOT based on any single real person)
