...
async function generateBundles() {
  ...
  for (let i = 0; i < bundlesToProcess.length; i++) {
    ...
    try {
      ...
      console.log(`   🎙️ Generating audio with Jane voice (no character names)...`);
      const audioBuffer = await generateElevenLabsAudio(bundle.cleanedText, JANE_VOICE_SETTINGS);
