/**
 * Generate combined preview text (Preview + Background + Hook) for Age Defiance #1 story
...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Age Defiance #1...');
...
- Describe Grace and her journey (failed swim at 28, gave up for 30 years, returned at 64, completed swim, graduated college at 69, became bodybuilder at 56)
- Mention transformation (swimming triumph, education achievement, health transformation)
- Key themes: age defiance, never give up, dreams don't expire, starting over later in life, perseverance
- Impact: "An inspiring story about proving that dreams don't expire and it's never too late to start over"
- Use character name "Grace" (composite story from 4 sources, NOT based on any single real person)
