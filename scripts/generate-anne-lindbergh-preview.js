...
// Preview text for the biography (A1 level - simple, descriptive)
const PREVIEW_TEXT = "In this inspiring biography, learn about Anne Morrow Lindbergh, a pioneering aviator and writer. She flew around the world with her husband Charles Lindbergh and wrote many books. Her most famous book, 'Gift from the Sea,' helped millions of women find meaning in their lives. Discover how she balanced adventure, family, and self-discovery.";
...
async function main() {
  console.log('✈️  Generating preview for "Anne Lindbergh: Aviator and Author" Biography');
