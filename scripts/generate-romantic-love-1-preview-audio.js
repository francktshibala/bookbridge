...
// VALIDATED VOICE ID - Jane (Family/emotional story narrator)
...
// PRODUCTION VOICE SETTINGS - Jane (Romantic/personal story narration)
...
async function main() {
  console.log('🎤 Generating combined preview audio for "Romantic Love #1: Cross-Cultural Love Story"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-romantic-love-1-preview-combined.js first.`);
  }
