...
// PRODUCTION VOICE SETTINGS - Sarah (Refugee story narration)
...
async function main() {
  console.log('🎤 Generating combined preview audio for "Refugee Journey Story"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-refugee-journey-preview-combined.js first.`);
  }
