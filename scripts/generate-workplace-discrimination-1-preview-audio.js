...
async function main() {
  console.log('🎤 Generating combined preview audio for "Workplace Discrimination #1"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-workplace-discrimination-1-preview-combined.js first.`);
  }
