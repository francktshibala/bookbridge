...
/**
 * Simplify "Romantic Love #1" to A1 level
 * Target: At least 15-20 minutes reading time (A1 level)
 */
...
- Keep proper nouns: Maya, Alex, etc.
`;
...
6. Keep proper nouns unchanged (Maya, Alex, etc.)
...
async function simplifyToA1() {
  console.log('📝 Simplifying Romantic Love #1 to A1 level...');
  console.log('🎯 Target: At least 15-20 minutes reading time');
  ...
  if (estimatedMinutes < 15) {
    console.log(`\n⚠️  WARNING: Story is ${estimatedMinutes} minutes, target is at least 15 minutes.`);
    console.log(`   Consider expanding the story before simplification.`);
  } else {
    console.log(`\n✅ Target met: ${estimatedMinutes} minutes (≥15 minutes)`);
  }
