...
// PRODUCTION VOICE SETTINGS - Daniel (Community Builder narration)
...
async function main() {
  console.log('🎤 Generating combined preview audio for "Community Builder #3"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-community-builder-3-preview-combined.js first.`);
  }
