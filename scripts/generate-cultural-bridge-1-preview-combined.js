...
const STORY_ID = 'cultural-bridge-1';
const CEFR_LEVEL = 'A1';
...
- Describe Mei and her challenge (growing up between two cultures, feeling different, parents' immigration)
- Mention main themes (bicultural identity, belonging, shame to pride, finding her place)
- Key insight: "Through finding community and accepting her heritage, Mei learns..."
- Impact: "A powerful message about identity, belonging, and being a bridge between two worlds"
- Use character name "Mei" (composite story from 5 sources, NOT based on any single real person)
