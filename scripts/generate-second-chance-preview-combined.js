...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Second Chance...');
  ...
  const prompt = `You are creating a combined preview text for an ESL story at A1 level about second chances and redemption.
...
2. PREVIEW (50-75 words): Meta-description style
   ...
   - Describe the journey: person who gets second chance after difficult times
   - Main theme: redemption, transformation, rebuilding life
   - Key insight: second chances are possible, people can change
   - Impact: message about hope and transformation

3. EMOTIONAL HOOK (50-100 words): Start with struggle
   - Use the existing hook as inspiration but simplify to A1 level
   - Keep the emotional impact: despair, rock bottom, facing impossible odds

4. BACKGROUND CONTEXT (30-50 words): Neutral, factual tone
   - Set the scene: people who face difficult times, second chances
