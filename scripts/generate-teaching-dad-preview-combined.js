...
if (!VALID_LEVELS.includes(targetLevel)) {
  ...
  console.log('Usage: node scripts/generate-teaching-dad-preview-combined.js [A1|A2]');
  process.exit(1);
}
...
async function main() {
  console.log('🎤 Generating combined preview for "First-Gen Student Teaching Dad to Read"');
