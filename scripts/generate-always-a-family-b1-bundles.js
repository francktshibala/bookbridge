...
async function generateBundles() {
  ...
  for (let i = 0; i < bundlesToProcess.length; i++) {
    ...
    try {
      ...
      console.log(`   🎙️ Generating audio with Daniel voice (no character names)...`);
      const audioBuffer = await generateElevenLabsAudio(bundle.cleanedText, DANIEL_VOICE_SETTINGS);
