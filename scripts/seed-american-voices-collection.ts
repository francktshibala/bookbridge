...
const BOOKS = [
  ...
  },
  {
    ...
    sentences: 22,
    bundles: 6,
    genres: ['Memoir', 'Historical'],
    themes: ['Education', 'Freedom', 'Literacy', 'Resilience'],
    ...
    era: 'Antebellum',
    literaryMovement: 'Slave Narrative',
    region: 'American Classics',
    country: 'United States',
  },
  {
    slug: 'dubois-meaning-of-progress',
    ...
    bundles: 6,
    genres: ['Memoir', 'Historical'],
    themes: ['Education', 'Community', 'Progress', 'Loss'],
    moods: ['Inspiring', 'Emotional', 'Reflective'],
    readingTimeMinutes: 11,
    difficultyScore: 0.4,
    popularityScore: 89,
  ...
  },
  {
    ...
    themes: ['Community', 'Service', 'Immigration', 'Belonging'],
    moods: ['Heartwarming', 'Hopeful'],
    readingTimeMinutes: 9,
    difficultyScore: 0.2,
    popularityScore: 87,
    publicationYear: 1910,
    era: 'Progressive Era',
    literaryMovement: 'Social Reform Memoir',
    region: 'American Classics',
    country: 'United States',
  },
];
