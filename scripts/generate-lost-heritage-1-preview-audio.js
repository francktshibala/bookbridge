...
async function main() {
  console.log('🎤 Generating combined preview audio for "Lost Heritage #1"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-lost-heritage-1-preview-combined.js first.`);
  }
