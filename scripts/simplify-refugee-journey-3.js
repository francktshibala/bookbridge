...
- Keep proper nouns: Omar, Hassan, Yusuf, Fatima, Ahmed, etc.
`;
...
6. Keep proper nouns unchanged (Omar, Hassan, Yusuf, Fatima, Ahmed, etc.)
...
async function simplifyStory() {
  const inputFile = path.join(process.cwd(), 'cache', 'refugee-journey-3-original.txt');
  const outputFile = path.join(process.cwd(), 'cache', 'refugee-journey-3-A1-simplified.txt');
