...
// PRODUCTION VOICE SETTINGS - Daniel (Youth Activism narration)
...
async function main() {
  console.log('🎤 Generating combined preview audio for "Youth Activism #1"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-youth-activism-1-preview-combined.js first.`);
  }
