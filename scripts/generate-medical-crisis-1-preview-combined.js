/**
 * Generate combined preview text (Preview + Background + Hook) for Medical Crisis #1 story
...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Medical Crisis #1...');
...
- Describe Rachel and her challenge (stroke, language loss, recovery)
- Mention main themes (family support, resilience, finding new ways, pole pole, pelican wings)
- Key insight: "Through her daughter's support and small steps, Rachel learns..."
- Impact: "A powerful message about hope, patience, and finding beauty in brokenness"
- Use character name "Rachel" (composite story, NOT based on any single real person)
