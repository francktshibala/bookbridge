...
/**
 * Simplify "Single Parent Rising #2" to A1 level
...
- Keep proper nouns: Isabella, Gabriel, Olivia, etc.
`;
...
6. Keep proper nouns unchanged (Isabella, Gabriel, Olivia, etc.)
...
async function simplifyToA1() {
  console.log('📝 Simplifying Single Parent Rising #2 to A1 level...');
