/**
 * Extract themes from Career Pivot source material using AI
...
async function extractThemes() {
  console.log('📖 Extracting themes from Career Pivot source material...');
  ...
  const prompt = `You are extracting THEMES and EMOTIONAL MOMENTS from source material about people who make major career pivots (leaving corporate jobs, teaching, or long-term careers to follow passion or find new paths).
DO NOT copy any text. Extract only:
1. Themes (e.g., career pivot, burnout, identity crisis, family-work balance, following passion, courage to change, persistence, finding new purpose, work-life balance, transformation)
2. Emotional moments (7+ moments: initial dissatisfaction, burnout, family disconnection, identity crisis, decision moment, fear/courage, breakthrough, transformation)
3. Facts (dates, locations, names - these are not protected by copyright)
4. Story arc (struggle → recognition → decision → courage → transformation)
