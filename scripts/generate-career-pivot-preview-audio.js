...
async function main() {
  console.log('🎤 Generating combined preview audio for "Career Pivot Story"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-career-pivot-preview-combined.js first.`);
  }
