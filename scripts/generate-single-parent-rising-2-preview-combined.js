/**
 * Generate combined preview text (Preview + Background + Hook) for Single Parent Rising #2 story
...
const STORY_ID = 'single-parent-rising-2';
const CEFR_LEVEL = 'A1';
const CACHE_DIR = path.join(__dirname, '..', 'cache');

async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Single Parent Rising #2...');
...
- Describe Isabella and her struggle (fleeing abusive relationship, homelessness, working two jobs)
- Mention transformation (starting jewelry business, craft fair moment "you are seen", building new life)
- Key themes: single parent, overcoming obstacles, domestic violence, homelessness, building business, being seen
- Impact: "An inspiring story about a single mother overcoming domestic violence and homelessness to build a successful business"
- Use character name "Isabella" (composite story from 5 sources, NOT based on any single real person)
