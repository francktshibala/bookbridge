...
/**
 * Simplify "Age Defiance #1" to A1 level
...
- Keep proper nouns: Grace, Rose, Cuba, Florida, etc.
`;
...
6. Keep proper nouns unchanged (Grace, Rose, Cuba, Florida, etc.)
...
async function simplifyToA1() {
  console.log('📝 Simplifying Age Defiance #1 to A1 level...');
