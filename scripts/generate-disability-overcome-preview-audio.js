...
async function main() {
  console.log('🎤 Generating combined preview audio for "Disability Overcome Story"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-disability-overcome-preview-combined.js first.`);
  }
