...
/**
 * Simplify "Grief to Purpose #1" to A1 level
...
- Keep proper nouns: Anna, Ethan, Ethan's Connection, Maya, etc.
`;
...
6. Keep proper nouns unchanged (Anna, Ethan, Ethan's Connection, Maya, etc.)
...
async function simplifyToA1() {
  console.log('📝 Simplifying Grief to Purpose #1 to A1 level...');
