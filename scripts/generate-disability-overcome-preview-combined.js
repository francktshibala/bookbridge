/**
 * Generate combined preview text (Preview + Background + Hook) for Disability Overcome story
...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Disability Overcome...');
...
- Mention the main theme (disability overcome, adaptation, finding new ways)
