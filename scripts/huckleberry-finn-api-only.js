// API-ONLY Huckleberry Finn Processing Script
// Bypasses database connection issues by using only HTTP API calls

// Configuration
const BOOK_ID = 'gutenberg-76' // Adventures of Huckleberry Finn by Mark Twain
...
async function main() {
  console.log('🚢 Starting API-only Huckleberry Finn processing...')
