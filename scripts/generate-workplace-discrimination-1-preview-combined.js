/**
 * Generate combined preview text (Preview + Background + Hook) for Workplace Discrimination #1 story
...
const STORY_ID = 'workplace-discrimination-1';
const CEFR_LEVEL = 'A1';
const CACHE_DIR = path.join(__dirname, '..', 'cache');

async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Workplace Discrimination #1...');
...
- Describe character: Jordan (faces workplace discrimination based on race, gender, disability)
- Mention journey: facing discrimination, fighting back, proving worth, becoming leader and mentor
- Key themes: overcoming discrimination, breaking barriers, proving worth, achieving success despite discrimination
- Impact: "An inspiring story about overcoming discrimination and achieving success"
- Use character name "Jordan" (composite story from 3 sources, NOT based on any single real person)
