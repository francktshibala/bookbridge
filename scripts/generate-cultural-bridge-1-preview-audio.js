...
async function main() {
  console.log('🎤 Generating combined preview audio for "Finding New Wings: A Medical Crisis Story"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-cultural-bridge-1-preview-combined.js first.`);
  }
