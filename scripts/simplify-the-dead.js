...
async function simplifyNecklace() {
  console.log(`📚 Simplifying "The Dead" to ${CEFR_LEVEL} level...`);
...
STORY CONTEXT: This is Joyce's "The Dead" - Gabriel Conroy attends Christmas party, realizes his wife still loves a dead man, has profound epiphany about life and death.
...
if (import.meta.url === `file://${process.argv[1]}`) {
  simplifyNecklace()
    .then((sentences) => {
      console.log('\n✅ The Dead simplified successfully!');
