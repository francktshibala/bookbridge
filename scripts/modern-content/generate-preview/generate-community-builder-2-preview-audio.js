...
async function main() {
  console.log('🎤 Generating combined preview audio for "Community Builder #2 Story"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-community-builder-2-preview-combined.js first.`);
  }
