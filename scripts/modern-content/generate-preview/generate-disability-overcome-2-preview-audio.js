...
async function main() {
  console.log('🎤 Generating combined preview audio for "Disability Overcome #2 Story"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-disability-overcome-2-preview-combined.js first.`);
  }
