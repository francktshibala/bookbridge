...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Career Pivot #2...');
  ...
  const prompt = `You are creating a combined preview text for an ESL story at A1 level about career pivots (unexpected job loss, financial crisis, therapeutic breakthroughs, new career paths).
...
2. PREVIEW (50-75 words): Meta-description style
   ...
   - Describe the journey: person who loses job unexpectedly, faces crisis, finds new path
   - Main theme: career pivot, reinvention, finding new purpose
   - Key insight: setbacks can lead to new opportunities, persistence pays off
   - Impact: message about hope, transformation, and new beginnings

3. EMOTIONAL HOOK (50-100 words): Start with struggle
   - Use the existing hook as inspiration but simplify to A1 level
   - Keep the emotional impact: unexpected job loss, financial crisis, fear

4. BACKGROUND CONTEXT (30-50 words): Neutral, factual tone
   - Set the scene: people lose jobs suddenly, face career barriers
