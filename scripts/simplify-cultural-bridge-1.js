...
/**
 * Simplify "Cultural Bridge #1" to A1 level
...
- Keep proper nouns: Mei, Toronto, Canada, China, Cantonese, etc.
`;
...
6. Keep proper nouns unchanged (Mei, Toronto, Canada, China, Cantonese, etc.)
...
async function simplifyToA1() {
  console.log('📝 Simplifying Cultural Bridge #1 to A1 level...');
