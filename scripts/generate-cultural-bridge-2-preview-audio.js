...
// VALIDATED VOICE ID - Daniel (Emotional/family story narrator)
...
// PRODUCTION VOICE SETTINGS - Daniel (Cultural Bridge #2 narration)
...
async function main() {
  console.log('🎤 Generating combined preview audio for "Cultural Bridge #2: Bridging Traditions and Modern Life"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-cultural-bridge-2-preview-combined.js first.`);
  }
