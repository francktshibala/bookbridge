...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text...');
...
- Combine three sections: Preview + Background + Hook
- Total length: 130-225 words
- Use simple connectors: "and", "but", "when"

STRUCTURE:
1. PREVIEW (50-75 words): Meta-description style
   - Start with: "In this inspiring story..." or "This powerful story..."
   - Describe the journey: refugee who fled war and found hope
   - Main theme: transformation, resilience, finding home
   - Key insight: epiphany moment that changed everything
   - Impact: message about strength and belonging

2. BACKGROUND CONTEXT (30-50 words): Neutral, factual tone
   - Set the scene: refugees fleeing war, arriving with nothing
...
3. EMOTIONAL HOOK (50-100 words): Start with struggle
   ...
   - Keep the emotional impact: fleeing home, arriving confused, epiphany moment
...
Write the combined preview text with all three sections. Use A1 level language throughout. Return ONLY the combined text, no explanations.`;
