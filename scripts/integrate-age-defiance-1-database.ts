/**
 * Integrate Age Defiance #1 story into database
...
if (!VALID_LEVELS.includes(targetLevel)) {
  ...
  console.log('Usage: npx tsx scripts/integrate-age-defiance-1-database.ts [A1|A2]');
  process.exit(1);
}
...
async function integrateDatabase() {
  console.log(`📚 INTEGRATING "Age Defiance #1" - A1 LEVEL WITH ENHANCED TIMING V3`);
