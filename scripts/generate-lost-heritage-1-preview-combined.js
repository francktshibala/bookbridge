/**
 * Generate combined preview text (Preview + Background + Hook) for Lost Heritage #1 story
...
const STORY_ID = 'lost-heritage-1';
const CEFR_LEVEL = 'A1';
const CACHE_DIR = path.join(__dirname, '..', 'cache');

async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Lost Heritage #1...');
...
- Describe character: Yuna (Korean adoptee, adopted at 4 months, grew up in America)
- Mention journey: learning Korean language, visiting Korea, seeing herself reflected, climbing mountain
- Key themes: reconnecting with lost heritage, finding identity, reclaiming cultural roots, belonging
- Impact: "An inspiring story about reconnecting with lost heritage and finding belonging"
- Use character name "Yuna" (composite story from 3 sources, NOT based on any single real person)
