/**
 * Integrate Single Parent Rising #1 story into database
...
const BOOK_ID = 'single-parent-rising-1';
...
if (!VALID_LEVELS.includes(targetLevel)) {
  ...
  console.log('Usage: npx tsx scripts/integrate-single-parent-rising-1-database.ts [A1|A2]');
  process.exit(1);
}
...
async function integrateDatabase() {
  console.log(`📚 INTEGRATING "Single Parent Rising #1" - A1 LEVEL WITH ENHANCED TIMING V3`);
