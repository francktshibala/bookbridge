...
/**
 * Generate Complete A2 Preview for "The Danger of a Single Story"
 * Creates both text (meta-description) AND audio (Daniel voice)
 */
...
// Daniel voice settings (from Power of Vulnerability A2)
...
async function generatePreview() {
  console.log('🎤 Generating A2 Preview for "The Danger of a Single Story"\n');

  // 1. Create preview text (meta-description format - NOT raw content!)
  ...
  // 2. Generate preview audio with Daniel voice
  console.log('🎵 Generating preview audio with Daniel voice...');
  console.log(`   Voice: ${DANIEL_VOICE_SETTINGS.voice_name} (${DANIEL_VOICE_SETTINGS.voice_id})`);
  ...
  const generatedAudio = await generateElevenLabsAudio(previewText, DANIEL_VOICE_SETTINGS);
  ...
  const metadata = {
    ...
    voice: {
      id: DANIEL_VOICE_SETTINGS.voice_id,
      name: DANIEL_VOICE_SETTINGS.voice_name,
      generationSpeed: DANIEL_VOICE_SETTINGS.speed,
  ...
  console.log('\n🎉 A2 Preview Generation Complete!');
  console.log('\n✅ Validation:');
  ...
  console.log('\n💡 Next: node scripts/generate-danger-of-single-story-a2-bundles.js --pilot');
}
