/**
 * Generate combined preview text (Preview + Background + Hook) for Medical Crisis #2 story
...
async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Medical Crisis #2...');
...
- Describe two people: Sarah (19, meningitis, lost both legs, became Paralympic snowboarder and Dancing with Stars finalist), Jake (13/15, cancer twice, lost one lung, climbed Mount Everest)
- Mention transformation (near-death → Paralympic athlete, terminal cancer → Everest climber)
- Key themes: medical crisis overcome, proving impossible possible, determination, resilience, choosing to live not die
- Impact: "An inspiring story about proving that the impossible is possible"
- Use character names "Sarah" and "Jake" (composite story from 2 sources, NOT based on any single real person)
