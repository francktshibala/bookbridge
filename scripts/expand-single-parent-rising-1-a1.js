...
- Add more detail to emotional moments (the phone call, being alone, the "Parents for Life" package, children helping)
- Expand dialogue and interactions between Lisa and her children
- Add more scenes showing Lisa's struggles and transformation
- Keep natural A1 flow
- Add new sentences to expand, don't merge existing ones
- Keep proper nouns: Lisa, James, Emily, Noah, "Parents for Life"
  ...
  try {
    const response = await openai.chat.completions.create({
      ...
      messages: [
        {
          role: 'system',
          content: 'You are expanding A1 level text for ESL learners. Maintain A1 constraints (max 12 words/sentence, simple vocabulary) while adding detail and emotion. Keep proper nouns unchanged (Lisa, James, Emily, Noah, "Parents for Life").',
        },
        {
          role: 'user',
          content: prompt,
