/**
 * Generate combined preview text (Preview + Background + Hook) for Youth Activism #1 story
...
const STORY_ID = 'youth-activism-1';
const CEFR_LEVEL = 'A1';
const CACHE_DIR = path.join(__dirname, '..', 'cache');

async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Youth Activism #1...');
...
- Describe three girls: Maya (15, climate action, sat alone outside parliament), Emma (11, book diversity campaign, collected 12,000 books), Sofia (8, water crisis, wrote to President)
- Mention transformation (lonely outsider → movement leader, frustration → systemic change, family crisis → national advocacy)
- Key themes: youth activism, one person can make a difference, your voice matters, you don't have to wait to be great
- Impact: "An inspiring story about proving that young people can change the world"
- Use character names "Maya", "Emma", "Sofia" (composite story from 3 sources, NOT based on any single real person)
