/**
 * Generate combined preview text (Preview + Background + Hook) for Romantic Love #1 story
...
const STORY_ID = 'romantic-love-1';
const CEFR_LEVEL = 'A1';
const CACHE_DIR = path.join(__dirname, '..', 'cache');

async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Romantic Love #1...');
...
- Describe Maya and her challenge (falls in love with Alex from different culture, family says no, forced to hide relationship for 5 years, choosing love over family approval)
- Mention main themes (cross-cultural love, family resistance, choosing love over tradition, finding voice)
- Key insight: "Through choosing love despite family resistance, Maya learns that love is worth fighting for and that she can have both family and love"
- Impact: "A powerful message about choosing love over tradition, building bridges between cultures, and finding your voice when the world says no"
- Use character names "Maya" and "Alex" (composite story from 4 sources, NOT based on any single real person)
