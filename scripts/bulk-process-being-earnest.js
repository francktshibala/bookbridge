...
// Configuration for The Importance of Being Earnest
const BOOK_ID = 'gutenberg-844' // The Importance of Being Earnest
...
async function detectChunkCount() {
  ...
  const maxChunks = 50 // Maximum to check (Being Earnest is a play, moderate length)
  let detectedCount = 0
...
async function main() {
  ...
  console.log(`${colors.bright}🎭 BULK PROCESSING THE IMPORTANCE OF BEING EARNEST${colors.reset}`)
  console.log('='.repeat(62))
  console.log(`  Book ID: ${BOOK_ID}`)
  console.log(`  Author: Oscar Wilde`)
  console.log(`  Type: 3-Act Play`)
  ...
  try {
    ...
    if (remaining > 0) {
      ...
      console.log(`${colors.green}🎉 THE IMPORTANCE OF BEING EARNEST FULLY PROCESSED!${colors.reset}`)
    }
