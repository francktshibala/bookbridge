...
async function main() {
  console.log('🎤 Generating combined preview audio for "Single Parent Rising #2"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-single-parent-rising-2-preview-combined.js first.`);
  }
