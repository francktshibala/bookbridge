...
// VALIDATED VOICE ID - Daniel (Professional/inspirational)
...
// PRODUCTION VOICE SETTINGS - Daniel (Refugee Journey narration)
...
async function main() {
  console.log('🎤 Generating combined preview audio for "Refugee Journey #3"');
  ...
  if (!fs.existsSync(combinedTextPath)) {
    throw new Error(`Combined text file not found: ${combinedTextPath}. Run generate-refugee-journey-3-preview-combined.js first.`);
  }
