/**
 * Generate combined preview text (Preview + Background + Hook) for Refugee Journey #3 story
...
const STORY_ID = 'refugee-journey-3';
const CEFR_LEVEL = 'A1';
const CACHE_DIR = path.join(__dirname, '..', 'cache');

async function generateCombinedPreview() {
  console.log('📝 Generating combined preview text for Refugee Journey #3...');
...
- Describe family: Fatima (mother), Ahmed (father), Omar (10 years old), Hassan (12, heart condition), Yusuf (8)
- Mention journey: 18 months, 8 countries, escaping execution order, saving Hassan's life
- Key themes: family escape together, dangerous journey, kindness from strangers, rebuilding together, staying together
- Impact: "An inspiring story about a family who escapes danger together and rebuilds their life together"
- Use character names "Fatima", "Ahmed", "Omar", "Hassan", "Yusuf" (composite story from 3 sources, NOT based on any single real person)
