-- BookBridge Subscription System Database Setup
...
CREATE INDEX IF NOT EXISTS idx_analyzed_books_user_id ON public.analyzed_books(user_id);
CREATE INDEX IF NOT EXISTS idx_analyzed_books_analyzed_at ON public.analyzed_books(analyzed_at);
...
DROP TRIGGER IF EXISTS handle_usage_tracking_updated_at ON public.usage_tracking;
